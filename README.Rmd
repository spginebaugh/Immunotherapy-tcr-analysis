...
![Overview UMAPs](output_figures/overview_umaps.png)
...
![CD45 Cell Proportions](output_figures/cd45_cell_prop.png)

Additionally, we can see that there are large differences between treatment groups within different celltypes.

![UMAP split patient](output_figures/cluster_split_patient_group.png)
...
![Tcell overview umaps](output_figures/tcell_overview_umaps.png)
...
![Azimuth annotation](output_figures/azimuth_umaps.png)

We can see that the proportion of CD4+ to CD8+ is relatively consistent between the treatment groups.

![Azimuth cell proportions](output_figures/azimuth_cell_prop.png)
...
![checkpoint group vln](output_figures/checkpoint_gene_exp_group.png)

We can see from density plots that colitis-enriched celltypes are sources of expression for these genes.

![checkpoint group density](output_figures/checkpoint_gene_exp_densityplot.png)
...
![foldchange cor](output_figures/de_comparison.png)
...
![TCR stats](output_figures/tcr_stats.png)
...
![TCR celltype stats](output_figures/celltype_tcr_stats.png)
...
![top20 clonotypes](output_figures/top20_clonotype.png)
